      ...
      <div className='text'>
        ...
        <div className="row featurette">
          ...
          <div className="col-md-7" >
            ...
            <p className="lead">The Traffic Light Reaction Test is designed to assess participants' ability to react swiftly and accurately to changing traffic signals. As the lights cycle randomly between red, yellow, and green, players must wait for the green light and press the spacebar promptly. Each correct response earns a point, encouraging quick thinking and precision.</p>
          ...
          <div className="button">
            ...
            <p>Please Fill in your details here : &nbsp;
              <a href='/contact'>
